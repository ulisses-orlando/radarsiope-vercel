    ...
    <div class="push-card" id="appmsg-card" style="display:none">
      ...
      <label style="display:flex;align-items:center;gap:6px;font-size:12px;color:#334155;cursor:pointer;margin-bottom:12px">
        ...
        Permitir que o assinante responda esta mensagem
            ...
            <!-- Toggle de modo -->
      <div style="display:flex;gap:8px;margin:14px 0 10px;background:#f1f5f9;padding:4px;border-radius:8px">
        <button id="appmsg-modo-lista" class="wa-modo-tab ativo" onclick="_appmsgToggleModo('lista')" style="flex:1;padding:8px 12px;border:2px solid transparent;border-radius:6px;background:transparent;font-size:12px;font-weight:600;cursor:pointer;color:#64748b">
          📋 Selecionar da lista
        </button>
        <button id="appmsg-modo-todos" class="wa-modo-tab" onclick="_appmsgToggleModo('todos')" style="flex:1;padding:8px 12px;border:2px solid transparent;border-radius:6px;background:transparent;font-size:12px;font-weight:600;cursor:pointer;color:#64748b">
          🚀 Todos os ativos
        </button>
      </div>
...
window._appmsgToggleModo = function (modo) {
  ...
  const panelLista = document.getElementById('appmsg-modo-assinantes'); // container da lista
  const panelTodos = document.getElementById('appmsg-panel-todos');
  
  // Esconde/mostra elementos da lista
