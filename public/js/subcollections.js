...
async function duplicarNewsletter(docId) { 
  ...
  const data = {
    ...original,
    edicao: (original.edicao || '') + ' (cópia)',
    data_publicacao: firebase.firestore.Timestamp.fromDate(new Date()),
    enviada: false,
    reactions: {},      // zera reactions
    resumo_bullets: original.resumo_bullets || [],
  };
