...
function _cadHtmlForm(ev) {
  ...
  '<div style="display:flex;flex-direction:column;gap:16px">' +
    ...
    '<div style="display:flex;flex-direction:column;gap:6px">' +
      '<label style="display:block;font-size:11px;font-weight:700;color:#475569;text-transform:uppercase;letter-spacing:.08em">Descrição <span style="color:#475569;font-weight:400">(opcional)</span></label>' +
    ...
    '<button id="cf-salvar" style="width:100%;background:#38bdf8;color:#0f172a;border:none;border-radius:10px;padding:10px;font-size:14px;font-weight:700;cursor:pointer;font-family:inherit;margin-top:8px">' +
