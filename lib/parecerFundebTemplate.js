 ...
 */
async function montarHTMLParecer(p) {
  ...
  const bimestre = d.bimestre_pdf || d.bimestre_referencia || 6;
...
<div class="pagina">
  ...
  <div class="faixa-mun">
    <div class="faixa-mun-esq"><div class="faixa-mun-nome">${esc(m.nome)} / ${esc(m.uf)}</div><div class="faixa-mun-cod">Base: ${bimestre}º Bimestre/${p.exercicio} (SIOPE)</div></div>
...
export { montarHTMLParecer, hashVerif };